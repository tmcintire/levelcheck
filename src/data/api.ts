...
export const eventDetails = (eventId: string): Promise<IEvent> =>
...
export const addEditParticipant = (
  participant: IParticipant,
...
export const skipTutorial = (tutorialValue: string, value: boolean) =>
  new Promise((resolve, reject) => {
...
export const addEditEvent = (event: IEvent) =>
  new Promise((resolve, reject) => {
